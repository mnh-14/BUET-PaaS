...
(deployer/routes/security.py) and stores them for the dashboard.
...
(scaling the offending Deployment to 0, or deleting the offending build Job)
using its own k8s ClusterRole — this endpoint only records what already
happened, for the dashboard to show.
